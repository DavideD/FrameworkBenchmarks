...
public class DbResource {
    ...
    @GET
    @Path("queries")
    public CompletionStage<Collection<World>> queries(@QueryParam("queries") String queries) {
    ...
    @GET
    @Path("updates")
    public CompletionStage<Collection<World>> updates(@QueryParam("queries") String queries) {
